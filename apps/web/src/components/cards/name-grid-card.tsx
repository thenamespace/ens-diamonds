...
export const NameGridCard = ({ name, price, ethUsd, isPricePending }: NameGridCardProps) => {
  return (
    <Link className="group block h-full" href={`/name/${name.label}.eth`}>
      <Card className="h-full gap-0 bg-transparent p-0 shadow-none transition-all duration-200 filter-[drop-shadow(0_2px_6px_rgba(18,21,28,0.08))] hover:-translate-y-0.75 hover:filter-[drop-shadow(0_10px_14px_rgba(18,21,28,0.13))]">
